...
function initializePendo() {
    console.log("releaseVersion", pendoOpts.getReleaseVersion());
    const releaseVersion = pendoOpts.getReleaseVersion() || "10.7.0.cl";
...
async function insertPendoScript() {
    ...
    console.log(window.pendoInitVariables , "window.pendoInitVariables");
